...
final class ConditionBuilder
{
     ...
     */
    public function build(string $condition): Condition
    {
        if ($condition === '') {
        ...
        return new Condition($condition, $this->dumpContext);
    }
