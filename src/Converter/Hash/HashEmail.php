...
final class HashEmail implements ConverterInterface, ContextAwareInterface
{
    /**
     * @var string[]
     */
    ...
    private HashText $textConverter;
    ...
    public function setParameters(array $parameters): void
    {
        ...
        $this->textConverter = new HashText();
    ...
    {
        $this->textConverter->setDumpContext($dumpContext);
    }
