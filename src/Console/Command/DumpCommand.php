...
final class DumpCommand extends Command
{
    ...
    public function configure(): void
    {
        ...
        $this->setName('gdpr-dump')
            ...
            // Default option is an empty array, this allows to differentiate not using the option and using `--password`
    ...
    private function addInputOptionsToConnectionParams(
        ...
        if ($password === []) {
            return; // Option was not provided
        }

        // Prompt for the password if `--password` was passed without a value
