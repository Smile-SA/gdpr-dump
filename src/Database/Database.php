...
final class Database
{
    ...
    public function connect(): void
    {
        ...
        switch ($driverName) {
            ...
            default:
                throw new DBALException(sprintf('The database driver "%s" is not supported.', $driverName));
        }
    }
    ...
    {
        return $this->connection ?? throw new DBALException('The database connection is not opened');
    }
    ...
    {
        return $this->driver ?? throw new DBALException('The database connection is not opened');
    }
    ...
    {
        return $this->metadata ?? throw new DBALException('The database connection is not opened');
    }
    ...
    {
        return $this->connectionParams ?? throw new DBALException('The database connection is not opened');
    }
