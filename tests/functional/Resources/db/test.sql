...
INSERT INTO `customers` VALUES(1, 'user1@test.org', 'firstname1', 'lastname1', 1, date_sub(now(), interval 60 day), 1);
INSERT INTO `customers` VALUES(2, 'user2@test.org', 'firstname2', 'lastname2', 1, date_sub(now(), interval 50 day), 1);
INSERT INTO `customers` VALUES(4, 'user3@test.org', 'firstname3', 'lastname3', 1, date_sub(now(), interval 40 day), 1);
INSERT INTO `customers` VALUES(5, 'user4@test.org', 'firstname4', 'lastname4', 1, date_sub(now(), interval 30 day), 2);
INSERT INTO `customers` VALUES(7, 'user5@test.org', 'firstname5', 'lastname5', 1, date_sub(now(), interval 20 day), 3);
